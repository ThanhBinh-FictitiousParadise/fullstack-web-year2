                        ...
                        <div class="cr-shop-categories">
                            ...
                            <div class="cr-checkbox">
                                <div class="cr-product-tabs">
                                    <ul class="cr-tags">
                                        <li class="active" data-filter="all" onclick="filterProducts('all')">All</li>
                                        @foreach ($category as $cate)
                                            <li class="category filter" data-filter="{{ $cate->id }}" onclick="filterProducts('{{ $cate->id }}')">
                                                {{ $cate->category_name }}
                                            </li>
                                        @endforeach
                                    </ul>
                ...
                <div class="col-lg-9 col-12 md-30" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="600">
                    ...
                    <div class="row col-100 mb-minus-24">
                        @foreach ($products as $product)
                            <div
                                class="mix category-{{ $product->category_id }} col-xxl-3 col-xl-4 col-6 cr-product-box mb-24">
                                <div class="cr-product-card">
                                    <div class="cr-product-image">
                                        <div class="cr-image-inner zoom-image-hover"
                                            style="width: 234.98px; height: 200px;">
                                    ...
                                    <div class="cr-product-details">
                                        ...
                                        <p class="cr-price"><span
                                                class="new-price">{{ number_format($product->sale_price) . 'VNĐ' }}</span>
                                            <span
                                                class="old-price">{{ number_format($product->selling_price) . 'VNĐ' }}</span>
                                        </p>
                                    </div>
                                </div>
                            </div>
